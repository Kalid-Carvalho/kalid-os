...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /*
    Flex column: .body cresce (flex:1) e fica clipado se passar.
    .assinatura, .footer-bar e .footer-notes são flex-shrink:0 —
    sempre aparecem, sempre abaixo do conteúdo, sem espaço vazio.
  */
  .page {
    width: 210mm;
    height: 297mm;
  ...
  /* Cresce para preencher, corta se passar */
  .body {
    flex: 1;
    min-height: 0;
    overflow: hidden;
  ...
  /* Sempre abaixo do .body, cola acima do rodapé */
  .assinatura {
    flex-shrink: 0;
    margin-top: 10px;
    line-height: 1.35;
  ...
  /* Rodapé — sempre no final, nunca sobrepõe */
  .footer-bar {
    flex-shrink: 0;
    background: #1a4080;
    color: #fff;
...
<div class="page">
  ...
  <div class="body">
    <p>
      ...
      <b>REQUERIDO POR</b> LEANDRO FELIPY ALBUQUERQUE DE SOUZA<br>
      <b>SITO À</b> RUA VISCONDE DE PORTO SEGURO, 767, FLORES, QD A4, LT PQ LARANJEIRAS, 69058090,<br>
      <b>DE PROPRIEDADE DE</b> LEANDRO FELIPY ALBUQUERQUE DE SOUZA
    </p>
    ...
    <p>
      CNAE/ATIVIDADE: 5611-2/01 02 - RESTAURANTES E SIMILARES COM FORNECIMENTO DE MUSICA TRANSMITIDA (SEM USO DE SOM AMPLIFICADO)<br>
