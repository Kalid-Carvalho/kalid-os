...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Flexbox column: page-body cresce, rodapé fica sempre embaixo */
  .page {
    width: 210mm;
    height: 297mm;
    background: #fff;
  ...
  /* Área de conteúdo: ocupa o espaço restante e corta se exceder */
  .page-body {
    flex: 1;
    min-height: 0;
    overflow: hidden;
  ...
  @media print {
    ...
    .assinatura { font-size: 10.5px; line-height: 1.28; margin-top: 10px; }
